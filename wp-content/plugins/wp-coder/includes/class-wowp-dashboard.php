...
class WOWP_Dashboard {
	...
	public function header_links(): void {
        ...
        <div class="wowp-links">
            <a href="https://wpcoder.pro/snippet/?utm_source=wordpress&utm_medium=admin-menu&utm_campaign=snippets" target="_blank">
            ...
            <a href="https://wpcoder.pro/category/web-items/?utm_source=wordpress&utm_medium=admin-menu&utm_campaign=items" target="_blank">
                <span class="codericon codericon-24px_web-design"></span>
                <span>Items</span>
            </a>
            <a href="https://wpcoder.pro/category/documentation/getting-started/?utm_source=wordpress&utm_medium=admin-menu&utm_campaign=documentation" target="_blank">
